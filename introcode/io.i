...
void do_work() {
    int fd = open("/tmp/file", 01 | 0100 | 01000,
    0400 | 0200);
    ((fd >= 0) ? (void) (0) : __assert_fail ("fd >= 0", "io.c", 11, __PRETTY_FUNCTION__));
    char buffer[20];
    sprintf(buffer, "hello world\n");
    int rc = write(fd, buffer, strlen(buffer));
    ((rc == strlen(buffer)) ? (void) (0) : __assert_fail ("rc == strlen(buffer)", "io.c", 15, __PRETTY_FUNCTION__));
